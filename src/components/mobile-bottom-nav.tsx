...
type View = 'dashboard' | 'transactions' | 'invoices' | 'reports' | 'settings' | 'exports' | 'backups' | 'audit-log' | 'accounts' | 'journal' | 'contacts' | 'periods' | 'ledger' | 'bank-recon' | 'aging' | 'cash-flow' | 'recurring' | 'budget' | 'projects' | 'settings-company' | 'settings-edelivery' | 'annual-report' | 'hermes-oversight' | 'einvoice-inbox';
