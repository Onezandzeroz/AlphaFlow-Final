...
export const GET = withGuard({
  ...
  try {
    ...
    const invoiceData: OIOUBLInvoiceData = {
      ...
      supplier: {
        id: `DK${userId.substring(0, 8).toUpperCase()}`,
        name: txUser?.businessName || ctx.businessName || DEFAULT_SUPPLIER.name,
        ...
        country: 'DK',
        vatNumber: `DK${userId.substring(0, 8).toUpperCase()}`,
        contactEmail: txUser?.email || ctx.email || DEFAULT_SUPPLIER.contactEmail,
      },
