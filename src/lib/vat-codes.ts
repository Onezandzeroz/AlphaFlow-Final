...
export const VAT_RATE_MAP: Record<string, number> = {
  ...
  K25: 25, K12: 12, K0: 0, KEU: 25, KUF: 25, NONE: 0,
};
...
/** Reverse-charge codes (omvendt betalingspligt) — supplier doesn't charge VAT,
 *  buyer self-assesses both input and output VAT at the Danish rate. */
export const REVERSE_CHARGE_CODES = new Set(['KEU', 'KUF']);
